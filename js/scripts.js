...
***************************************************/
	var austDay = new Date("September 26, 2021");
		$('#launch_date').countdown(
	{
	until: austDay,
	 layout: '<ul class="countdown"><li><span class="number">{dn}<\/span><br/><span class="time">Hari<\/span><\/li><li><span class="number">{hn}<\/span><br/><span class="time">Jam<\/span><\/li><li><span class="number">{mn}<\/span><br/><span class="time">Menit<\/span><\/li><li><span class="number">{sn}<\/span><br/><span class="time">Detik<\/span><\/li><\/ul>'
	  });
...
/***************************************************
	ABOUT OVERLAY
***************************************************/
	var open_overlay = ('#open'), close_overlay = ('#close'), content = ( '.content' ), overlay = ('#overlay'), about = ('#eventinfo'),
